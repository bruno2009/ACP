...
<li> All principal minors $A$ are nonnegative.</li>
</ol> 
</p>
</div>
...
Now let $y \in \mathbb{R}_{\small\setminus0}^{p}$ be any $n \times 1$ column vector. Thus
...
<p><strong>Algebraically:</strong>. 
</p>

<p><strong>Geometrically:</strong>. 
</p>

...
With the measure of the correlation between $Y$ and $x$, you might decide which variable may stay in this specific component or remove. There is no magical formula that you might use to decide whether to leave or remove this specific variable. To me, if $|{\Large r}_{\small Y_{j},\textbf{x}_{i}}| < 0.25$, you perhaps need to think about how important this variable is in this component. And so, you decide. 
